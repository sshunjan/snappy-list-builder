...
/*
	...
	Description: The ultimate email list builder.
	Version: 1.0
	Author: Simran
	Author URI: www.facebaook.com/perfectfurnishers
	License: GPL2
	License URI: ex.com
	Text Domain: Mail-Plugin
*/
...
//1.9
// load external files
add_action('wp_enqueue_script', 'slb_public_scripts');
